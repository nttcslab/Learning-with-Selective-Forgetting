...
parser.add_argument('--ini-file', type=str, default='./ini/stn_t4.ini')
...
if __name__ == '__main__':
    ...
    num_class_per_task = [49,49,49,49]
    ...
    sz = 224
    channel = 3
    #num_class_per_task = 49
    is_task_wise = 0
    img_size = [224, 224, 3]
    x_tr_key = sample_keys(x_tr_key, n_outputs=49, num_sample=num_keys_per_cls, channel=channel, sz=sz)


    ptr1='../000_datagrid/00_FCL/datasets/stanford/N5/train0'
    ptr2='../000_datagrid/00_FCL/datasets/stanford/N5/train1'
    ptr3='../000_datagrid/00_FCL/datasets/stanford/N5/train2'
    ptr4='../000_datagrid/00_FCL/datasets/stanford/N5/train3'

    pte1='../000_datagrid/00_FCL/datasets/stanford/N5/test0'
    pte2='../000_datagrid/00_FCL/datasets/stanford/N5/test1'
    pte3='../000_datagrid/00_FCL/datasets/stanford/N5/test2'
    pte4='../000_datagrid/00_FCL/datasets/stanford/N5/test3'

    train_datasets = [utils.train_loader_cropped(ptr1, batch_size), utils.train_loader_cropped(ptr2, batch_size), utils.train_loader_cropped(ptr3, batch_size), utils.train_loader_cropped(ptr4, batch_size)]
    test_datasets  = [utils.test_loader_cropped(pte1, batch_size), utils.test_loader_cropped(pte2, batch_size), utils.test_loader_cropped(pte3, batch_size), utils.test_loader_cropped(pte4, batch_size)]
